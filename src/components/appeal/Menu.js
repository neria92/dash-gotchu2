...
export const Menu = ({ selectTypeAppeal, setSelectTypeAppeal }) => {
            ...
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                ...
                <div className="flex md:order-2">
                    <div className="hidden relative mr-3 md:mr-0 md:block">
                        ...
                        <input type="text" id="search" className="block p-2 pl-10 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-300 dark:border-gray-300 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Buscar por misión..." />
                    </div>
                ...
                <div className="hidden text-center justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-3" id='menu' ref={menu}>
                    <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-lg md:font-medium">
                        <Button
                            isActive={selectTypeAppeal === 'process'}
                            onChange={setSelectTypeAppeal}
                            title='En proceso'
                            value='procces'
                        />
                        <Button
                            isActive={selectTypeAppeal === 'finish'}
                            onChange={setSelectTypeAppeal}
                            title='Finalizadas'
                            value='finish'
                        />
